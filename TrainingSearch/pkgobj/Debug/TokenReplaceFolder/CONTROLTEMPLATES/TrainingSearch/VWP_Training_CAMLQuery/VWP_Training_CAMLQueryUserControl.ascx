<%@ Assembly Name="TrainingSearch, Version=1.0.0.0, Culture=neutral, PublicKeyToken=a2a94ae9a295a36f" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VWP_Training_CAMLQueryUserControl.ascx.cs" Inherits="TrainingSearch.VWP_Training_CAMLQuery.VWP_Training_CAMLQueryUserControl" %>
