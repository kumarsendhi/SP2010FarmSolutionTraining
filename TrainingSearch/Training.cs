...
namespace Training {
	...
	public partial class TrainingDataContext : Microsoft.SharePoint.Linq.DataContext {
		
		#region Extensibility Method Definitions
		partial void OnCreated();
		#endregion
		
		public TrainingDataContext(string requestUrl) : 
				base(requestUrl) {
			this.OnCreated();
		}
		
		[Microsoft.SharePoint.Linq.ListAttribute(Name="Classes")]
		public Microsoft.SharePoint.Linq.EntityList<Item> Classes {
			get {
				return this.GetList<Item>("Classes");
			}
		}
